...
const sideNavVariants = cva(
  'absolute h-screen custom-navbar-bg space-y-6 px-8 py-8 inset-y-0 left-0 sm:relative sm:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out',
  {
    variants: {
      collapsed: {
        true: 'w-20',
